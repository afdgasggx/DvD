class EnvironmentSettings:
    def __init__(self):
        ...
        self.model_path_sr = 'checkpoints/backup/model_best_sr.pt'    # Pre-trained super-resolution model path for evaluation
        self.dewarping_model_path = "checkpoints/backup/geotr.pth"
